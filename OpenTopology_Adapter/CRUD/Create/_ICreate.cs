...
namespace BH.Adapter.OpenTopology
{
    public partial class OpenTopologyAdapter
    {
        ...
        // The Create should only contain the logic that generates the objects in the Adapter software.
        ...
        //      //  - calling `Convert` methods from the BHoM type to the Adapter object model
        //      //    (Convert methods should be defined in the specific `Convert` folder);
        //      //  - any API call that do the actual export to the Adapter software.
