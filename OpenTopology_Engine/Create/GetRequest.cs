...
namespace BH.Engine.Adapter.OpenTopology
{
    public static partial class Create
    {
        public static GetRequest GetRequest(Geosp.BoundingBox boundingBox, OpenTopologyConfig config)
        {
        ...
        private static Dictionary<string, object> Parameters(Geosp.BoundingBox boundingBox, OpenTopologyConfig config)
        {
